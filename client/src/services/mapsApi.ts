...
export const mapsApi = {
  ...
  getMapsByCategory: async (categoryType: 'borough' | 'city'): Promise<Map[]> => {
    const response = await axios.get(`/api/maps/category/${categoryType}`);
    return response.data;
  },

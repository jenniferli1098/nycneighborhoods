...
Total lines: 262 (excluding header)

Extracted 212 countries:
...
const countriesData = [
  ...
  { name: 'Congo', code: 'CG', continent: 'Africa', description: 'A country in Africa.' },
  { name: 'Congo', code: 'CD', continent: 'Africa', description: 'A country in Africa.' },
  ...
  { name: 'Saint Helena', code: 'SH', continent: 'Africa', description: 'A country in Africa.' },
  ...
  { name: 'Western Sahara', code: 'EH', continent: 'Africa', description: 'A country in Africa.' },
  ...
  { name: 'British Indian Ocean Territory (Chagos Archipelago)', code: 'IO', continent: 'Asia', description: 'A country in Asia.' },
  { name: 'Brunei Darussalam', code: 'BN', continent: 'Asia', description: 'A country in Asia.' },
  ...
  { name: 'Korea', code: 'KP', continent: 'Asia', description: 'A country in Asia.' },
  { name: 'Korea', code: 'KR', continent: 'Asia', description: 'A country in Asia.' },
  { name: 'Kuwait', code: 'KW', continent: 'Asia', description: 'A country in Asia.' },
  { name: 'Kyrgyz Republic', code: 'KG', continent: 'Asia', description: 'A country in Asia.' },
  { name: 'Lao People's Democratic Republic', code: 'LA', continent: 'Asia', description: 'A country in Asia.' },
  ...
  { name: 'Oman, Sultanate of', code: 'OM', continent: 'Asia', description: 'A country in Asia.' },
  { name: 'Pakistan', code: 'PK', continent: 'Asia', description: 'A country in Asia.' },
  { name: 'Palestinian Territory, Occupied', code: 'PS', continent: 'Asia', description: 'A country in Asia.' },
  ...
  { name: 'Spratly Islands', code: 'XS', continent: 'Asia', description: 'A country in Asia.' },
  { name: 'Sri Lanka', code: 'LK', continent: 'Asia', description: 'A country in Asia.' },
  { name: 'Syrian Arab Republic', code: 'SY', continent: 'Asia', description: 'A country in Asia.' },
  ...
  { name: 'Gibraltar', code: 'GI', continent: 'Europe', description: 'A country in Europe.' },
  { name: 'Greece', code: 'GR', continent: 'Europe', description: 'A country in Europe.' },
  { name: 'Guernsey, Bailiwick of', code: 'GG', continent: 'Europe', description: 'A country in Europe.' },
  { name: 'Holy See (Vatican City State)', code: 'VA', continent: 'Europe', description: 'A country in Europe.' },
  ...
  { name: 'Jersey, Bailiwick of', code: 'JE', continent: 'Europe', description: 'A country in Europe.' },
  ...
  { name: 'Luxembourg, Grand Duchy of', code: 'LU', continent: 'Europe', description: 'A country in Europe.' },
  { name: 'Macedonia', code: 'MK', continent: 'Europe', description: 'A country in Europe.' },
  ...
  { name: 'Slovakia (Slovak Republic)', code: 'SK', continent: 'Europe', description: 'A country in Europe.' },
  ...
  { name: 'Aruba', code: 'AW', continent: 'North America', description: 'A country in North America.' },
  ...
  { name: 'Bonaire, Sint Eustatius and Saba', code: 'BQ', continent: 'North America', description: 'A country in North America.' },
  ...
  { name: 'Curaçao', code: 'CW', continent: 'North America', description: 'A country in North America.' },
  ...
  { name: 'Greenland', code: 'GL', continent: 'North America', description: 'A country in North America.' },
  ...
  { name: 'Netherlands Antilles', code: 'AN', continent: 'North America', description: 'A country in North America.' },
  ...
  { name: 'Sint Maarten (Netherlands)', code: 'SX', continent: 'North America', description: 'A country in North America.' },
  ...
  { name: 'United States Minor Outlying Islands', code: 'UM', continent: 'Oceania', description: 'A country in Oceania.' },
...
// Summary: 212 countries total

// Countries by continent:
// Africa: 56 countries
// Asia: 47 countries
// Europe: 53 countries
// North America: 29 countries
